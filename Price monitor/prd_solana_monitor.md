...
- **FR-1.1**: Subscribe to pool account changes via Helius Geyser WebSocket
...
- **FR-2.1**: Store prices with structure: `Map<TokenPair, Map<DEX, PriceData>>`
...
- **FR-4.3**: CLMM pricing: `price = (sqrtPrice / 2^64)^2`
